...
- [Приложение: NPC](#p33)
  ...
  - [Горожане](#p47)
  - [Пропавшие люди](#p48)
- [Приложение: Пантеон и домены](#приложение-пантеон-и-домены)
...
Мир Азалия запечатан древними печатями, изолирующими его от внешних планов существования. О печатях знают лишь ангелы.
Нет связи с богами, патронами и иными внешними силами.

Если печати становятся нестабильными или разрушаются, открывается доступ в иные планы — вплоть до вторжений демонов и
магических аномалий.

Люди мира не знают о богах и поклоняются ангелам, которые фактически исполняют их функции.

## Империя и Драгонвинг

Драгонвинг — полуостров-протекторат: формально подчинён Империи, но фактически стремится к независимости, особенно после
того, как Империя не смогла защитить города от вторжения демонов.

Представители Империи могут столкнуться с недоверием или враждебностью со стороны местных жителей.

## Церковь Света

Церковь Света (культ ангелов) — единственная разрешённая религия. Напрямую с ангелами общается лишь верхушка; остальные
верят в то, что ангелы существуют и направляют их.
...
Все практикующие магию обязаны иметь разрешение на пребывание в Империи или лицензию на использование магии.
...
**Тифлинги** — результат экспериментов магов с демонической кровью последних 2–3 лет. Никому, кроме создателей, они не
...
**Клирики и паладины.** Действуют через веру в ангела (см.
[Приложение: Пантеон и домены](#приложение-пантеон-и-домены)), как правило без прямого ответа.

**Маги (Wizards) и колдуны (Sorcerers).** Допустимы, но должны скрывать свою практику или получить легальный статус.
