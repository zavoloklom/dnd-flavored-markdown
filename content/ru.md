...
## Нападение в Заброшенном районе

_Начало Лотвиэля (апреля)_

- Ночью **[Бертрам](#)** (местный пьяница) проваливается в старый колодец в **[Заброшенном районе](#карта-города)**, ведущий в
...
Город небольшой (около 500 жителей) и стоит на скальных
террасах. Основные мотивы — узкие каменные улочки, крутые лестницы и арочные проходы. По утрам пахнет солью, водорослями
и рыбой; днём — гул мастерских; к вечеру спускается густой туман.

Город разделён на несколько районов — Портовый, Заброшенный, Бархатный, Центральный и квартал Ремесленников.

ЛОкация строится по шаблону
Описание - то как локация выглядит для игроков
Персонажи - какие персонажи находятся в локации
Предметы - какие предметы можно найти
Информация - какую информацию можно узнать
События - в каждой локации с героями может произойти одно или несколько событий, это сделано для того чтобы посещение локации было интересным, даже если оно не продвигает в расследовании
...
Типа в локациях информация относится только к тому что можно узнать в этом месте, в то время как в карточке персонажей могут рассказать что-то в любом встреченом месте. Иногда оно дублируется

::: page

# Причал

_Номер на [карте](#p12) - **1**._
_Доступен только утром в первый день, перед входом в город._
...
Пока герои осматривают дом Гюнтер внимательно за ними следить и торопить. Если герои попробуют что-то унести, то будет их
останавливать.
...
- `@Investigation 10` Несколько сломанных клеток, явно взломаны снаружи — кто-то открыл их или прогрыз. Следы крыс, но
...
- `@Perception 14` В одной из трещин запуталась шерсть крысы и тонкая паутина. В другой — едва слышный шелест, но
...
> Здание гарнизона стоит рядом с городской ратушей, его каменные стены массивны и крепки, а на входе
...
> Массивные городские ворота, окованные железом, возвышаются среди старых, но прочных стен, сложенных из
...
> Роза стоит перед воротами, её поза напряжённая, рука сжата в кулак. Перед ней стоит молодой стражник,
...
> Хурган подходит быстрым шагом, его лицо напряжено. Он молча окидывает взглядом Розу, затем поворачивается
к стражнику.
>
>Хурган (глухо, резко):
>
...
> Высокие своды, скрипучие деревянные полы и запах пыли и старых пергаментов. Массивные шкафы с книгами
