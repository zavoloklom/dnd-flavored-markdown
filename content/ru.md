...
- Торговка благовониями **[Мария](#)** поставляла Абрахаму ингредиенты, нужные для экспериментов с ядом пауков.
...
- Мария тайно встречается со стражником **[Гюнтером](#)** на [сторожевой башне](#) во время его ночных дежурств.
...
- В город прибывает **[Гастон](#)** в поисках шкатулки, которую должны были доставить Петер и Бошир. Ночью он пытается
  пробраться [в бухту с моря (отметка 11 на карте)](#карта-города), но его замечают моряки, и он отступает.
